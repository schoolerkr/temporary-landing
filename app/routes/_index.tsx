  ...
  return (
    <main className="flex justify-center min-h-screen">
      <div className="flex flex-col w-full">
        <section
          className="relative flex flex-col h-[100vh] items-center justify-center bg-white"
          style={{
            backgroundImage:
        ...
        >
          <div className="flex flex-col gap-9 items-center">
            <h1 className="relative flex gap-5 items-center text-5xl font-bold text-gray-800">
              <img
                src={YellowSymbol}
                alt="Symbol"
